...
Button(root, text="Create File", command=create_file).pack(pady=2)

Button(root, text="Read File", command=read_file).pack(pady=2)

Button(root, text="Update File", command=update_file).pack(pady=2)

Button(root, text="Delete File", command=delete_file).pack(pady=2)

Button(root, text="Rename File", command=rename_file).pack(pady=2)

Button(root, text="Create Folder", command=create_folder).pack(pady=2)

Button(root, text="Delete Folder", command=delete_folder).pack(pady=2)
